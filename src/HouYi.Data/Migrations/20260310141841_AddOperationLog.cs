    ...
    public partial class AddOperationLog : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeveledReferenceData", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExtraData = table.Column<string>(type: "nvarchar(max)", maxLength: 4096, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Positions_AspNetUsers_ConsultantId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HighestEducation = table.Column<byte>(type: "tinyint", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resumes_Places_PlaceId",
                        column: x => x.PlaceId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ResumeId = table.Column<string>(type: "nvarchar(36)", maxLength: 36, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Communications_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Communications_Resumes_ResumeId",
                        column: x => x.ResumeId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Feedback = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                    HiringStatus = table.Column<int>(type: "int", nullable: false),
                    HiringStatusChangedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Recommendations_Positions_PositionId",
                        column: x => x.PositionId,
                        principalTable: "Positions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Recommendations_Resumes_ResumeId",
                        column: x => x.ResumeId,
                        principalTable: "Resumes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Interviewer = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Status = table.Column<byte>(type: "tinyint", nullable: false),
                    Feedback = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Interviews_Recommendations_RecommendationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Communications_PositionId",
                table: "Communications",
                column: "PositionId");

            migrationBuilder.CreateIndex(
                name: "IX_Communications_ResumeId",
                table: "Communications",
                column: "ResumeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Interviews_RecommendationId",
                table: "Interviews",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Positions_ConsultantId",
                table: "Positions",
                column: "ConsultantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Recommendations_PositionId",
